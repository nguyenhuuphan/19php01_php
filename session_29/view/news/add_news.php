  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" name="addNews" action="#" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group <?php echo ($errName != '')?'has-error':''; ?>">
                  <label for="inputName">Post Title</label>
                  <input type="text" class="form-control" id="inputName" placeholder="Enter Title" name="name" value="<?= $name; ?>">
                ...
                <?php 
                	if($image_name != ''){
                		echo "<div class='form-group'><img src='uploads/post/" . $image_name ."'></div>";
                	}
                ?>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary" name="add_post">Add New</button>
              </div>
            </form>
          </div>
    </section>
