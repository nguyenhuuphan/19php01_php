...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="libs/assets/css/ionicons.min.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="libs/assets/css/jquery-jvectormap.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="libs/assets/css/AdminLTE.min.css">
  <link rel="stylesheet" href="libs/assets/css/bootstrap-datepicker.min.css">
  <link rel="stylesheet" href="libs/assets/css/select2.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="libs/assets/css/_all-skins.min.css">
	  ...
	  <header class="main-header">
	    ...
	    <nav class="navbar navbar-static-top">
	              ...
	              <li>
	                ...
	                <ul class="menu">
	                  <li><!-- start message -->
	                    <a href="#">
	                      <div class="pull-left">
	                        <img src="libs/assets/img/user2-160x160.jpg" class="img-circle" alt="User Image">
	                      </div>
	                      <h4>
	                        Support Team
	                  ...
	                  <li>
	                    <a href="#">
	                      <div class="pull-left">
	                        <img src="libs/assets/img/user3-128x128.jpg" class="img-circle" alt="User Image">
	                      </div>
	                      <h4>
	                  ...
	                  <li>
	                    <a href="#">
	                      <div class="pull-left">
	                        <img src="libs/assets/img/user4-128x128.jpg" class="img-circle" alt="User Image">
	                      </div>
	                      <h4>
	                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="libs/assets/img/user2-160x160.jpg" class="user-image" alt="User Image">
